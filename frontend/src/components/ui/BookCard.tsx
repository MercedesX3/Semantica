...
export default function BookCard({
  ...
  return (
    <div className="inline-flex flex-col gap-4 cursor-pointer" onClick={onClick}>
      ...
      <div className="self-stretch flex flex-col gap-1">
        <div className="flex justify-between items-start">
          <div className="flex flex-col">
            <span className="text-base font-bold font-sans">{book.title}</span>
            <span className="text-sm font-semibold font-sans text-zinc-600">{book.author}</span>
          </div>
          {showHeart && (
